...
<div class="active-grid-item-container">
  <div class="grid-nav">
    <div class="previous-item">Previous country &gt;</div>
    <div class="next-item">&lt; Next country</div>
  </div>
...
<div class="page-sections">
  <section class="page-section grid-section countries page-nav-section">
    <h1 class="section-title page-nav-title">Sub-Saharan Africa</h1>
    <?= \Firebelly\PostTypes\Country\get_countries(); ?>
  </section>
</div>